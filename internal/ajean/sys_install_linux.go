...
func cmdInstall(args []string) error {
	...
	// 3. Symlink current binary to /usr/local/bin/ajean
	...
	// « ajean » — on ne contrôle rien de tout ça, et un binaire renommé qui casse
	...
	// lisent $AJEAN_HOME. L'ancien /etc/default/ajean est laissé en place — le
