...
// dataDirs est l'arborescence complète de $LOKI_HOME. Rien d'autre n'y est
// créé : tout le reste vit dans loki.db.
func dataDirs() []string {
	return []string{LokiHome(), backendsDir(), binDir(), presetsDir(), memoryDir(), modelsDir(), workspaceDir()}
}
...
// l'écran d'accueil, ou « loki llamacpp install », qui les renseigne.
