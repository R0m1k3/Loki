...
// + les helpers de nommage d'outils propres à loki.
//
// Le format du fil (Msg, capacités, confinement de chemin) vit dans nodewire,
// paquet SANS dépendance, pour que le client léger loki-node le partage sans
// tirer tout loki. Ici on ne fait qu'exposer ces symboles sous les noms
