...
func TestMCPEnsureDeduplicatesConcurrentConnects(t *testing.T) {
	...
	cfg := MCPServerConfig{Command: "loki-binaire-inexistant-pour-test", Enabled: true}
...
func TestMCPEndToEnd(t *testing.T) {
	...
	out := mcpCall(echoName, map[string]any{"message": "bonjour-loki"})
	if !strings.Contains(out, "bonjour-loki") {
