...
// sys_tray_windows.go — icône de Loki dans la zone de notification Windows (system
// tray). Quand on lance l'app (double-clic ou `loki app`), l'UI web s'ouvre dans
// le navigateur ET une petite icône apparaît près de l'horloge : elle montre que
// Loki tourne et offre un menu « Ouvrir Loki » / « Quitter ».
//
