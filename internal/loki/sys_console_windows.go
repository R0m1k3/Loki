...
// aussitôt et réaffichait son invite AVANT la sortie d'Loki, ce qui donnait
//
//	C:\Users\Nathan>loki
//
//	C:\Users\Nathan>loki 0.8.0 — manager llama.cpp + UI web
//
// La même cause cassait la redirection et les tubes, et rendait `loki chat`
// inutilisable depuis un terminal (le shell et Loki se disputaient l'entrée).
//
