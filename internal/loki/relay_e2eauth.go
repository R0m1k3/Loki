...
// fois à l'agent via un code affiché par « loki link » (canal hors-bande : le log du
...
//
// Générés par « loki link code » (ou affichés par « loki link »), ils sont
...
// SHA256( ECDH(agentPriv, uPub) || "loki-authchan-v1" ). Symétrique de la version
