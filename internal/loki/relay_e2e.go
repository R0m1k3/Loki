...
// au `loki link` — l'utilisateur la confirme dans le portail, ce qui défait tout
...
func e2eKeyPath() string { return filepath.Join(LokiHome(), ".e2e_key") }
